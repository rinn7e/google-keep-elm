...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {noteList: a, modal: b, form: c};
	});
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('bg-gold flex items-center white'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('pa2 b'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('flex-auto pa2'),
							_1: {ctor: '[]'}
						},
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('bg-white flex items-center black-60 shadow-1'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('pa2 flex-auto pointer'),
										_1: {
											ctor: '::',
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"Input":["String","String"],"CreateNote":[],"CloseModal":[],"ViewNote":["Main.NoteModel"],"DeleteNote":[]}}},"aliases":{"Main.NoteModel":{"args":[],"type":"{ id : Int , title : String , desc : String , pin : Bool , date : String , tag : List String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
